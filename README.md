...
* entertainment_center.py - main Python script to run this movie trailer project
...
* Added the background image and text colour for the website.
* Added the rounded corners for movie tiles to appear more attractive website.
